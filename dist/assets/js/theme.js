(function($) {
	...
	if(!window.themeRunOnce) {
		$("a.dtbtn.profile").hover(() => {
			$("a.dtbtn.profile").append("<span>&nbsp; Profile</span>");
		}, () => {
			console.log($(this))
			$("a.dtbtn.profile span").remove();
		});
	}
	...
	--------------------- */
		...
		$('.em_load_videos').imagesLoaded(function() {

			if ($.fn.isotope) {

				var $portfolio = $('.em_load_videos');
